...
import { buildQuery } from "@/sql/02_silver/21_int_first_session_after_signup/01_create_table";
...
const execute = async (config: Config, args: unknown) => {
  ...
  const sqlPath =
    "sql/02_silver/21_int_first_session_after_signup/01_create_table.ts";
